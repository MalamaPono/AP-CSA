...
import roadgraph.MapGraphDuration;
...
public class GraphLoader 
{
	...
	//for extension MapGraphDuration
	public static void loadRoadMap(String filename, roadgraph.MapGraphDuration map)
	{
		loadRoadMap(filename, map, null, null);
	}
