...
public class GraphAdjList extends Graph {
	 ...
	 * @return List<Integer> a list of indices of vertices.  
	 */		
	 //Easy Verison using past already made methods of getting Neighbors from a certain node.
	 public List<Integer> getDistance2Easy(int v) {
		 
		 //this prevents us from accessing the actual List in our adjacency list to ensure that we don't make any mistakes and change anything.
	 ...
	 //A little harder version that jsut solely works with adjacency list without the help of any other methods. 
	 public List<Integer> getDistance2(int v) {
		 
		 //this prevents us from accessing the actual List in our adjacency list to ensure that we don't make any mistakes and change anything.
		 List<Integer> distanceOne = new ArrayList<Integer>(adjListsMap.get(v)); 
		 List<Integer> distanceTwo = new ArrayList<Integer>();
		 
		 for(int vertex : distanceOne) {
			 for(int secondVertex : adjListsMap.get(vertex)) {
				 distanceTwo.add(secondVertex);
			 }
		 }
		 return distanceTwo;
