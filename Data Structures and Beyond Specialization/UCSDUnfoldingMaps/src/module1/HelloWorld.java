...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		// For pixels we must remember that (0,0) is the pixel in the upper left corner. 
		// Any x value to the right are all positive x-values
		// Any y value below are positive y-values
		map1 = new UnfoldingMap(this, 50, 50, 350, 500, provider);
		map2 = new UnfoldingMap(this,390,50,350,500,provider);

		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
	    // map2.zoomAndPanTo(zoomLevel, new Location(21.2762509f,-157.7633519f)); //My home Hawaii
	    map2.zoomAndPanTo(zoomLevel, new Location(-22.9f,-43.2f)); //Rio de Janiro Brazil
