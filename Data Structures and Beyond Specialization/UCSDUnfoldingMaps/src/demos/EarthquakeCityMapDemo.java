...
//	    map = new UnfoldingMap(this, 200, 50, 650, 600, new MBTilesMapProvider(mbTilesString));
	    ...
	    Location ChileLoc = new Location(35.7f,72.5f);
	    PointFeature ChileEq = new PointFeature(ChileLoc);
	    ChileEq.addProperty("name", "demolisher");
	    ChileEq.addProperty("year", 1890);
	    ...
	    for(PointFeature x:features) {
	    	markers.add(new SimplePointMarker(x.getLocation(), x.getProperties()));
	    }
