...
public class CityMarker extends SimplePointMarker {
	 ...
	 */
	//since we are no longer extending the PApplet Class like in the Earthquake City Map class
	//we can no longer use Processing library and its graphics so we must use a different way 
	//to draw graphics, thus we are using a PGraphics object which is the standard way to draw graphics in java. 
