...
public class BasicDocument extends Document 
{
	...
	public int getNumSentences()
	{
		...
		/*
		Other way to do this is through splitting the text by punctuation, and each section of the text is a sentence.
	...
	public int getNumSyllables()
	{
		...
		List<String> words = getTokens("[a-zA-Z]+"); //gets all the words without any spaces.
		int count = 0;
		
		for(String word : words) {
			word = word.toLowerCase(); //makes sure word is lower case so syllables can be counted.
